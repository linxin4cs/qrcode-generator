...
const btnConfirmTcc = document.getElementById("btn--confirm-tcc");
...
btnConfirmTcc.addEventListener("click", generateQrCode);

function generateQrCode() {
  const textareaContentCode = document.getElementById("textarea--content-code");
  const qrcContent = textareaContentCode.value;
  if (qrcContent === "") {
    alert("必须输入内容！");
    return;
  }
